                  ...
                  <div className="border-t-2 border-gray-200 px-2 pt-4 mb-2">
                    <div className="flex flex-col space-y-3 items-center justify-center">
                      ...
                      <button
                        ...
                        className={`flex flex-row items-center justify-center gap-x-3 btn btn-primary btn-lg mr-1 px-3 w-1/2 ${
                          canPerformSearch() ? "text-black" : "text-gray-100"
                        }`}
                      >
                        <FaSearch /> Search
                      </button>
                      ...
                      >
                        ...
                        <div className="d-flex align-items-start">
                          <img
                            ...
                            className="rounded-circle mr-1 ml-3"
                            alt="1"
                            width={40}
                            height={40}
                          />
                          ...
                          <div className="flex-grow-1 ml-3 text-mainBlue">
                            ...
                            <div className="small">
                              <small>
                                <i className="fas fa-envelope text-mainBlack">
                                  {" "}
                                  Send Message
                                </i>
                              </small>
